...
const App = () => {
  ...
  const videojuegos = [
    { id: 101, nombre: 'Cyberpunk 2077: Phantom Liberty', categoria: 'Acción RPG', precio: 59.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co7497.webp', descripcion: 'Expansión futurista cyberpunk con Ray Tracing', plataforma: 'PC, PlayStation, Xbox', descuento: 20 },
    { id: 102, nombre: 'Elden Ring', categoria: 'Acción RPG', precio: 49.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co4jni.webp', descripcion: 'Épica aventura de FromSoftware - GOTY 2022', plataforma: 'PC, PlayStation, Xbox', descuento: 25 },
    { id: 103, nombre: 'Call of Duty: Modern Warfare III', categoria: 'FPS', precio: 69.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co1rsg.webp', descripcion: 'El FPS más épico del año - Multijugador online', plataforma: 'PC, PlayStation, Xbox', bestseller: true },
    ...
    { id: 105, nombre: 'FIFA 24', categoria: 'Deportes', precio: 59.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co5vmg.webp', descripcion: 'El simulador de fútbol más realista', plataforma: 'PC, PlayStation, Xbox', descuento: 15 },
    { id: 106, nombre: 'Spider-Man 2', categoria: 'Acción', precio: 69.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co79vq.webp', descripcion: 'Aventuras épicas del Hombre Araña en 4K', plataforma: 'PlayStation 5', exclusivo: true },
    { id: 107, nombre: "Baldur's Gate 3", categoria: 'RPG', precio: 59.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co670h.webp', descripcion: 'RPG de fantasía épica - Más de 100 horas', plataforma: 'PC, PlayStation', bestseller: true },
    { id: 108, nombre: 'Starfield', categoria: 'Acción RPG', precio: 69.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co39vv.webp', descripcion: 'Exploración espacial épica de Bethesda', plataforma: 'PC, Xbox', descuento: 30 },
    { id: 109, nombre: 'Mortal Kombat 1', categoria: 'Lucha', precio: 59.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co9b8f.webp', descripcion: 'Combates brutales y fatalities épicos', plataforma: 'PC, PlayStation, Xbox' },
    { id: 110, nombre: 'Alan Wake 2', categoria: 'Terror', precio: 49.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co6jar.webp', descripcion: 'Terror psicológico sobrenatural premiado', plataforma: 'PC, PlayStation, Xbox', descuento: 35 },
    { id: 111, nombre: 'The Last of Us Part II', categoria: 'Acción/Aventura', precio: 39.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co7dw9.webp', descripcion: 'Historia post-apocalíptica emocional', plataforma: 'PlayStation', bestseller: true },
    { id: 112, nombre: 'Grand Theft Auto VI', categoria: 'Acción', precio: 79.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co2lbv.webp', descripcion: 'El juego más esperado de la década', plataforma: 'PC, PlayStation, Xbox', preventa: true },
    { id: 113, nombre: 'God of War Ragnarök', categoria: 'Acción/Aventura', precio: 59.99, imagen: 'https://images.igdb.com/igdb/image/upload/t_cover_big/co5s5v.webp', descripcion: 'Épica nórdica de Kratos y Atreus', plataforma: 'PlayStation, PC', bestseller: true },
  ];
